...
<c:url var="customerAddAPI" value="/lien-he"/>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form modelAttribute="customerEdit" id="listForm" method="POST">
                        ...
                        <form:input path="customerPhone" class="form-control" placeholder="Số điện thoại"/>
                        <form:input path="demand" class="form-control" placeholder="Nhu cầu"/>
